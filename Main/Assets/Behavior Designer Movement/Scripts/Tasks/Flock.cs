...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class Flock : NavMeshAgentGroupMovement
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            for (int i = 0; i < agents.Length; ++i) {
                ...
                navMeshAgents[i].destination = agentTransforms[i].position + velocity * lookAheadDistance.Value;
            }
            ...
            for (int i = 0; i < agents.Length; ++i) {
                ...
                if (agentIndex != i) {
                    ...
                    if (Vector3.SqrMagnitude(agentTransforms[i].position - agentTransform.position) < neighborDistance.Value) {
                        ...
                        alignment += navMeshAgents[i].velocity;
