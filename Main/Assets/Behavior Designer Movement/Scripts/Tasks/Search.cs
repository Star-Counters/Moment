...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class Search : NavMeshAgentMovement
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (senseAudio.Value) {
                objectFound.Value = MovementUtility.WithinHearingRange(transform, offset.Value, audibilityThreshold.Value, hearingRadius.Value, objectLayerMask);
